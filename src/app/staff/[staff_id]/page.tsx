			...
			<section className='flex flex-row items-center justify-between w-full'>
				<section className='flex flex-row items-center justify-between w-3/4 '>
					...
					<section className='flex flex-col ml-5'>
						...
						<p className={`${data.department ? 'text-lg' : 'hidden'}`}> {data.department} </p>
						<p className='text-lg'>{data.institution}</p>
					</section>
					</section>
					<section className='flex flex-col ml-5 text-right'>
						<a href={data.gs_link} className='text-lg hover:underline hover:text-[#9888FF]'>Google Scholar</a>
						<a href={data.linkedin} className='text-lg hover:underline hover:text-[#9888FF]'>LinkedIn</a>
						<a href={data.research_gate} className='text-lg hover:underline hover:text-[#9888FF]'>Research Gate</a>
					</section>
				</section>
